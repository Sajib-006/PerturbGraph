...
H5AD="/home/sajibacharjeedip/shared_disk/Perturb/data/K562_essential_normalized_singlecell_01.h5ad"
...
OUTDIR="eccb/bench_extended_all_methods"
LOGDIR="${OUTDIR}/logs"
